...
var CustomOrder = (function (_Order2) {
  ...
  _createClass(CustomOrder, [{
    ...
    value: function execute() {
      ...
      if (!this.hasEnoughUnits()) {
        log.trace("CustomOrder not enough units", this);
        return false;
      }

      log.trace("CustomOrder execute", this);
...
exports.minePlunderVillages = function () {
  ...
  $("#plunder_list [id*=village_]").each(function (index, element) {
    try {
      ...
      // Template C
      var template_c_a = je.find(".farm_icon_c");
      var template_c = {};
...
var Settings = Storage.get(SETTINGS_STORAGE_NAME) || constants.DEFAULT_SETTINGS;
